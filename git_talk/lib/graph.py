    ...
    if match:
        ...
        if message.startswith("Revert"):
            ...
            if match:
                ...
                g_graph +=  '\n    "' + commitHash + '"->"' + str(origRevertHash) + '"[label="Revert",style=dotted,fontcolor="azure4",color="azure4"]'
...
g_graph += "\n}"
print("}")
with open('my.dot','w') as m:
    m.write(g_graph)
from graphviz import Digraph
g = Digraph('G', filename = 'my.dot')
